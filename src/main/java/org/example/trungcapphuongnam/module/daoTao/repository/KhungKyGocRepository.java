...
@Repository
public interface KhungKyGocRepository extends JpaRepository<KhungKyGoc, Long> {

    Page<KhungKyGoc> findByMaKyContainingIgnoreCaseOrTenKyContainingIgnoreCaseOrMoTaContainingIgnoreCase(
            String maKy,
            String tenKy,
            String moTa,
            Pageable pageable
