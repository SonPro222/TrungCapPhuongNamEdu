...
import { getAllBaiTapLop } from '@/api/lms/response/fetchResponse_BaiTapLop.js';
import { createBaiTapLop, updateBaiTapLop, deleteBaiTapLop } from '@/api/lms/request/fetchRequest_BaiTapLop.js';

const pageTitle = 'Bài tập lớp';
const fields = [
  {
    "key": "dotGiaoBaiOnlineId",
    "label": "Dot giao bai online id",
    "type": "number"
  },
  {
    "key": "baiTapOnlineId",
    "label": "Bai tap online id",
    "type": "number"
  },
  {
    "key": "lopHocPhanId",
    "label": "Lop hoc phan id",
    "type": "number"
  },
  {
    "key": "cauHinhDanhGiaId",
    "label": "Cau hinh danh gia id",
    "type": "number"
  },
  {
    "key": "nguoiGiaoTaiKhoanId",
    "label": "Nguoi giao tai khoan id",
    "type": "number"
  },
  {
    "key": "thoiGianMo",
  ...
  {
    "key": "thoiGianDong",
    "label": "Thoi gian dong",
    "type": "datetime-local"
  },
  {
    "key": "thoiLuongLamBaiPhut",
    "label": "Thoi luong lam bai phut",
    "type": "number"
  },
  {
    "key": "soLanLamToiDa",
    "label": "So lan lam toi da",
    "type": "number"
  },
  {
    "key": "cachTinhDiem",
    "label": "Cach tinh diem",
    "type": "number"
  },
  {
    "key": "choPhepXemDiem",
    "label": "Cho phep xem diem",
    "type": "checkbox"
  },
  {
    "key": "choPhepXemDapAn",
    "label": "Cho phep xem dap an",
    "type": "checkbox"
  },
  {
    "key": "tronCauHoi",
  ...
  {
    "key": "choPhepLamQuaHan",
    "label": "Cho phep lam qua han",
    "type": "checkbox"
  },
  {
    "key": "giaoVienDuocChinhSua",
    "label": "Giao vien duoc chinh sua",
    "type": "checkbox"
  },
  {
    "key": "trangThai",
...
const loadData = async () => {
  ...
  error.value = '';
  try {
    const response = await getAllBaiTapLop();
...
const submitForm = async () => {
  ...
  try {
    ...
    if (editingId.value) {
      await updateBaiTapLop(editingId.value, payload);
    } else {
      await createBaiTapLop(payload);
    }
    resetForm();
    await loadData();
  } catch (err) {
