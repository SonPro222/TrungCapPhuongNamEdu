  ...
  <div class="module-layout">
    <aside class="module-sidebar">
      <div class="brand-block">
        ...
        <h2>Điểm</h2>
        <p>
          Theo dõi đánh giá học tập từ bài kiểm tra, bài nộp đến cấu hình đánh giá và kết quả học
          phần.
        </p>
      </div>
...
const routePathLabel = computed(() => route.path.replace(/^\//, '') || 'diem');

const navGroups = [
  {
    title: 'Đánh giá',
    items: [
      { label: 'Bài kiểm tra', to: '/diem/bai-kiem-tra', path: 'diem/bai-kiem-tra' },
      { label: 'Bài nộp sinh viên', to: '/diem/bai-nop-sinh-vien', path: 'diem/bai-nop-sinh-vien' },
      { label: 'Cấu hình đánh giá', to: '/diem/cau-hinh-danh-gia', path: 'diem/cau-hinh-danh-gia' },
      { label: 'Điểm chi tiết', to: '/diem/diem-chi-tiet', path: 'diem/diem-chi-tiet' },
    ],
  },
  {
    title: 'Kết quả',
    items: [
      { label: 'Kết quả lớp học phần', to: '/diem/ket-qua-lop-hoc-phan', path: 'diem/ket-qua-lop-hoc-phan' },
      { label: 'Kết quả môn học', to: '/diem/ket-qua-mon-hoc', path: 'diem/ket-qua-mon-hoc' },
    ],
  },
];
</script>
