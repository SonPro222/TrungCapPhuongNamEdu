  ...
  <div class="module-layout">
    <aside class="module-sidebar">
      <div class="brand-block">
        ...
        <h2>Sinh viên</h2>
        <p>
          Quản lý hồ sơ sinh viên, chương trình đang theo học và các quyết định miễn trừ, bảo lưu.
        </p>
      </div>
...
const routePathLabel = computed(() => route.path.replace(/^\//, '') || 'sinh-vien');
const navGroups = [
  {
    title: 'Hồ sơ học tập',
    items: [
      { label: 'Sinh viên', to: '/sinh-vien/sinh-vien', path: 'sinh-vien/sinh-vien' },
      { label: 'Sinh viên chương trình', to: '/sinh-vien/sinh-vien-chuong-trinh', path: 'sinh-vien/sinh-vien-chuong-trinh' },
      { label: 'Miễn trừ bảo lưu', to: '/sinh-vien/mien-tru-bao-luu', path: 'sinh-vien/mien-tru-bao-luu' },
    ],
  },
];
</script>
