  ...
  <div class="module-layout">
    <aside class="module-sidebar">
      <div class="brand-block">
        ...
        <h2>Thi</h2>
        <p>
          Quản lý lịch thi, danh sách sinh viên dự thi, đề thi và bài thi sinh viên.
        </p>
      </div>
...
const routePathLabel = computed(() => route.path.replace(/^\//, '') || 'thi');
const navGroups = [
  {
    title: 'Tổ chức thi',
    items: [
      { label: 'Lịch thi', to: '/thi/lich-thi', path: 'thi/lich-thi' },
      { label: 'Sinh viên dự thi', to: '/thi/sinh-vien-du-thi', path: 'thi/sinh-vien-du-thi' },
      { label: 'Đề thi', to: '/thi/de-thi', path: 'thi/de-thi' },
      { label: 'Bài thi sinh viên', to: '/thi/bai-thi-sinh-vien', path: 'thi/bai-thi-sinh-vien' },
    ],
  },
];
</script>
